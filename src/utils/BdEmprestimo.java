...
// Prepara conexão p/ receber o comando SQL
    ...
    public void devolve(int id) throws SQLException {
    ...
    public List<RelatorioEmprestimo> getRelatorioEmprestimosPorCliente(int idCliente) throws SQLException {
        String sql = "SELECT e.id_emprestimo AS id, COALESCE(l.exemplar, \"Sem registro\") AS livro, e.data_emprestimo, e.devolvido"
        + " FROM emprestimo e"
        ...
        ResultSet rs = stmt.executeQuery();
        List<RelatorioEmprestimo> emprestimos = new ArrayList();
        while (rs.next()) {
            RelatorioEmprestimo r = new RelatorioEmprestimo(rs.getInt("id"), rs.getString("livro"), rs.getString("data_emprestimo"), rs.getBoolean("devolvido"));
            emprestimos.add(r);
        }
